...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var numbro__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! numbro */ "./node_modules/numbro/dist/numbro.min.js");
/* harmony import */ var numbro__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(numbro__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var numbro_dist_languages_min__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! numbro/dist/languages.min */ "./node_modules/numbro/dist/languages.min.js");
/* harmony import */ var numbro_dist_languages_min__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(numbro_dist_languages_min__WEBPACK_IMPORTED_MODULE_1__);


Object.values(numbro_dist_languages_min__WEBPACK_IMPORTED_MODULE_1___default.a).forEach(function (l) {
  return numbro__WEBPACK_IMPORTED_MODULE_0___default.a.registerLanguage(l);
});
/* harmony default export */ __webpack_exports__["default"] = ({
  mounted: function mounted() {
    if (Nova.config.locale) {
      numbro__WEBPACK_IMPORTED_MODULE_0___default.a.setLanguage(Nova.config.locale.replace('_', '-'));
    }
  },
  computed: {
    formattedValue: function formattedValue() {
      console.log({
        ...
        format: this.format,
        prefix: this.prefix,
        numbro: numbro__WEBPACK_IMPORTED_MODULE_0___default()(this.value),
        "final": this.prefix + numbro__WEBPACK_IMPORTED_MODULE_0___default()(this.value).format(this.format)
      });

      if (!this.isNullValue) {
        return this.prefix + numbro__WEBPACK_IMPORTED_MODULE_0___default()(new String(this.value)).format(this.format);
      }
